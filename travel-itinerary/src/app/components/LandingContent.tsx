...
// Small client hook to check verification state
    ...
    <main className="min-h-dvh bg-gradient-to-b from-fuchsia-100 via-white to-indigo-50 dark:from-violet-950 dark:via-neutral-950 dark:to-indigo-950">
      ...
      <section id="destinations" className="mx-auto max-w-7xl px-4 py-12 md:px-8">
        <div className="flex items-end justify-between">
          ...
          {/* GATED button */}
          <PlannerLink className="hidden rounded-xl border border-indigo-200 bg-white px-4 py-2 text-sm text-gray-900 hover:bg-white dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100 md:block">
            Generate my plan
          </PlannerLink>
        </div>
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            >
              ...
              <h3 className="text-base font-semibold text-gray-900 dark:text-neutral-100">{feature.title}</h3>
